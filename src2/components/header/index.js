  ...
  return (
    <React.Fragment>
      <header className="rows">
        ...
        <div className="rows middle-elements" style={{ border: "1px solid transparent", width: "100%"}}>
          ...
          <nav className="navigation-links hide-on-mobile" style={{ marginLeft: "20px", marginright: "20px"}}>
